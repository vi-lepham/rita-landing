...
},{"ev-emitter":"BQvw"}],"QdeU":[function(require,module,exports) {
"use strict";
...
var header = document.querySelector(".s-header"); // Preload images
...
Promise.all([preloadImages(".tiles-line-img"), preloadFonts("ftf6jal")]).then(function () {
  // Remove loader (loading class)
  document.body.classList.remove("is-loading"); // Initialize the Locomotive scroll
...
},{"locomotive-scroll":"ez7q","imagesloaded":"lc7f"}]},{},["QdeU"], null)